...
let { WP, GOLD, WARBOND, EVENT_KEY, NYBOND, PLATINUM, APRILBOND, APRILMAPPIECE, APRILDOUBLON, BLACK_FRIDAY_BOND, HOTMAYBOND, INDEPENDENCEBOND } = require("%appGlobals/currenciesState.nut")

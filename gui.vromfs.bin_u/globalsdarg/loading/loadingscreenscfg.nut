...
let screensList = {
  ...
  simple_ship_10 = {
    camp = [ "ships" ]
    weight = 1.0
    mkLayers = @() mkSingleImageLayers("ui/bkg/login_bkg_s_10.avif")
  }
  complex_ship_1 = {
    camp = [ "ships" ]
    weight = 1.0
  ...
  simple_tank_24 = {
    camp = [ "tanks" ]
    weight = 1.0
    mkLayers = @() mkSingleImageLayers("ui/bkg/login_bkg_t_27.avif")
  }
  simple_tank_25 = {
    camp = [ "tanks" ]
    weight = 1.0
  ...
  simple_airplane_5 = {
    camp = [ "air" ]
    weight = 1.0
    mkLayers = @() mkSingleImageLayers("ui/bkg/login_bkg_a_5.avif")
  }
  simple_airplane_6 = {
    camp = [ "air" ]
    weight = 1.0

...
from "gameplayBinding" import closeIngameGui, doPlayerBailout, inFlightMenu, isCameraNotFlight, isPlayerCanBailout
from "guiMission" import leave_mp_session, quit_to_debriefing, interrupt_multiplayer, get_respawns_left,
...
from "guiRespawn" import getSpareSlotsMask, getDisabledSlotsMask
from "mission" import is_benchmark_game_mode, get_game_mode, get_game_type, get_local_mplayer
from "multiplayer" import is_mplayer_host
from "replays" import is_replay_playing, is_replay_paused
from "%appGlobals/clientState/clientState.nut" import isInFlightMenu, isInBattle, canBailoutFromFlightMenu
...
from "%rGui/battleData/battleData.nut" import curBattleUnit, curBattleItems
from "app" import toggle_freecam, is_freecam_enabled
from "%rGui/debriefing/battleResult.nut" import requestEarlyExitRewards

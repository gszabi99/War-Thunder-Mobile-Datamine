...
import "android.account.googleplay" as googlePlayAccount
import "android.account.huawei" as hmsAccount
from "app" import exitGame
from "auth_wt" import get_player_tags, isExternalApp2StepAllowed, isHasEmail2StepTypeSync,
  isHasWTAssistant2StepTypeSync, isHasGaijinPass2StepTypeSync, check_login_pass_async,
  convertExternalJwtToAuthJwtWithNewAppId
...
import "ios.account.apple" as appleAccount
...
from "%appGlobals/pServer/bqClient.nut" import sendErrorBqEvent, sendLoadingStageBqEvent
from "auth_wt" import load_local_settings
from "%rGui/login/authState.nut" import authState
from "%appGlobals/errorMsgBox.nut" import errorMsgBox
from "subStageAuthNSwitch.nut" import login_nswitch


let openUrl = @(baseUrl, isAlreadyAuthenticated = false, biqQueryKey = "")

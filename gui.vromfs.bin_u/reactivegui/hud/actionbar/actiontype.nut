...
let actions = [
  "TORPEDO", "TOOLKIT", "EXTINGUISHER", "SMOKE_SCREEN", "MEDICALKIT", "DEPTH_CHARGE", "MINE", "MORTAR", "ROCKET",
  "SUPPORT_PLANE", "SUPPORT_PLANE_2", "SUPPORT_PLANE_3", "SUPPORT_PLANE_4", "SUPPORT_PLANE_CHANGE", "SUPPORT_PLANE_GROUP_ATTACK",
  "SUPPORT_PLANE_RETURN", "DIVING_LOCK", "SMOKE_GRENADE", "ARTILLERY_TARGET", "WINCH", "WINCH_ATTACH", "WINCH_DETACH"
]

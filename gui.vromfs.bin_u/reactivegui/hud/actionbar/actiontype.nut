...
let actions = [
  "TORPEDO", "TOOLKIT", "EXTINGUISHER", "SMOKE_SCREEN", "MEDICALKIT", "DEPTH_CHARGE", "MINE", "MORTAR", "ROCKET", "IRCM", "FIREWORK",
  "SUPPORT_PLANE", "SUPPORT_PLANE_2", "SUPPORT_PLANE_3", "SUPPORT_PLANE_4", "SUPPORT_PLANE_CHANGE", "SUPPORT_PLANE_GROUP_FLY_TO",
  "SUPPORT_PLANE_GROUP_ATTACK", "SUPPORT_PLANE_GROUP_HUNT", "SUPPORT_PLANE_GROUP_DEFEND", "SUPPORT_PLANE_GROUP_RETURN",
  ...
  "WINCH", "WINCH_ATTACH", "WINCH_DETACH"
]

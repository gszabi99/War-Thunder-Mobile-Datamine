...
from "multiplayer" import get_mp_session_id_str, is_local_multiplayer
from "scriptRespondent" import registerRespondent
from "%sqstd/string.nut" import splitStringBySize
from "%sqstd/underscore.nut" import isEqual
import "%globalScripts/ecs.nut" as ecs
from "%appGlobals/clientState/clientState.nut" import isInBattle, battleSessionId, isSingleMissionOverrided
from "%appGlobals/clientState/initialState.nut" import shouldDisableMenu, isOfflineMenu
from "%appGlobals/clientState/missionState.nut" import battleCampaign, battleUnitClasses, mainBattleUnitName
import "%appGlobals/data/getDefaultBattleData.nut" as getDefaultBattleData
...
from "%appGlobals/sqevents.nut" import mkCmdSetBattleJwtData, mkCmdGetMyBattleData, mkCmdSetDefaultBattleData,
  CmdSetMyBattleData
from "%appGlobals/util.nut" import is_multiplayer
from "menuBattleData.nut" import battleData, isBattleDataActual, actualizeBattleData, bdOvrMissionParams,
...
function onSetMyBattleData(evt, _eid, comp) {
  ...
  if (isDebugMyBattleData) {
    ...
    file.close()
    log($"Result saved to wtmBattleDataDedic.json")
  }

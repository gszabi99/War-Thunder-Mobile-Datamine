...
let lbRowHeight = hdpxi(60)
let lbDotsRowHeight = lbRowHeight / 3
let lbTableHeight = saSize[1] - lbHeaderHeight - lbFooterHeight - 2 * lbVGap
let lbPageRows = (lbTableHeight - lbHeaderRowHeight - lbTableBorderWidth - lbDotsRowHeight).tointeger() / lbRowHeight -1

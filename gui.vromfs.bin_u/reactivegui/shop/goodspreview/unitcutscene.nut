...
from "hangar" import start_prem_cutscene, stop_prem_cutscene, get_prem_cutscene_preset_ids, SHIP_PRESET_TYPE,
  SUBMARINE_PRESET_TYPE, TANK_PRESET_TYPE, AIR_FIGHTER_PRESET_TYPE, AIR_BOMBER_PRESET_TYPE
...
from "%rGui/unit/hangarUnit.nut" import loadedHangarUnitName, loadedHangarUnitSkin, needReloadHangarBattleData

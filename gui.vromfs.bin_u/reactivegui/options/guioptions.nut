...
let optListNative = [
  ...
  "OPT_TANK_AUTO_TURNER"
  "OPT_WALER_CAMERA_FORWARD_MOVEMENT"
  "OPT_WALKER_MOVEMENT_CONTROL"
  "OPT_WALKER_STEP_SHAKE_CAMERA"
  "OPT_TANK_LEAVE_ZOOM_ON_KILL"
]

...
from "soundOptions" import SND_TYPE_MASTER, SND_TYPE_MUSIC, SND_TYPE_MENU_MUSIC, SND_TYPE_SFX,
  ...
  is_sound_inited, get_sound_volume, set_sound_volume
let { get_option_voice_message_voice = @() 1, set_option_voice_message_voice = null } = require("soundOptions")
...
let CAN_USE_RADIO_VOICE = set_option_voice_message_voice != null
...
return {
  soundOptions = [
    ...
    CAN_USE_RADIO_VOICE ? optRadioMessagesVoice : null
  ]
  radioMessageVoice
}

...
let elements = {
  ...
  btn_forward = ["ship_main_engine_rangeMax", "submarine_main_engine_rangeMax", "ID_TRANS_GEAR_UP", "walker_throttle_rangeMax"]
  btn_left_right = ["ship_steering_rangeMax", "ship_steering_rangeMin", "gm_steering_right", "gm_steering_left", "walker_steering_right", "walker_steering_left"]
  btn_left = ["ship_steering_rangeMax", "gm_steering_left", "walker_steering_rangeMax"]
  btn_right = ["ship_steering_rangeMin", "gm_steering_right", "walker_steering_rangeMin"]
  btn_backward = ["ship_main_engine_rangeMin", "submarine_main_engine_rangeMin", "ID_TRANS_GEAR_DOWN", "walker_throttle_rangeMin"]
